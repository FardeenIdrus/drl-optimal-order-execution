...
# Tables cited by the results chapter, plus the
# per-run tables the appendix carries. Keep this list in step with the chapter.
WANTED = [
    # Data chapter
    # d1a_sources.tex is NOT synced. The table was withdrawn on supervisor review (mostly
    # plain text; reduced to a paragraph). Section 3.1's prose now carries what it held. The builder still writes the
