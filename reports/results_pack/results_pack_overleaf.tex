...
deadline-leaning failure appears on this track too (seven flagged runs; the L2 mirror of
...
\begin{table}[h]\centering\small
\caption{Frozen-replay track validation summary, all 14 arms. Source: the saved agents' validation re-evaluation.}
\label{tab:t7}
\resizebox{0.85\textwidth}{!}{% Auto-generated from the v2 saved-model validation re-evaluation (l2_test_prep).
...
\begin{center}\scriptsize% Auto-generated: all 70 L2 agents, per seed (v2 saved-model validation
